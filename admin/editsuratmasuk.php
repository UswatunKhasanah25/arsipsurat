                  ...
                  <div class="x_content">
                    ...
                    <form action="proses/proses_editsuratmasuk.php" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input value="<?php echo $data['kategori'];?>" type="text" id="kategori" name="kategori" required="required" maxlength="7" placeholder="Masukkan Kategori" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input value="<?php echo $data['judul'];?>" type="text" id="judul" name="judul" required="required" placeholder="Masukkan Judul" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
