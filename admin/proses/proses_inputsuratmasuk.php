<?php
    ...
    if (!($tgl_masuk=='') and !($kategori =='') and !($nomor_suratmasuk =='') and !($tgl_surat =='') and !($judul =='')  and   
		...
		$sql = "INSERT INTO tb_suratmasuk(tanggalmasuk_suratmasuk, kategori, nomor_suratmasuk, tanggalsurat_suratmasuk, judul, kepada_suratmasuk, perihal_suratmasuk, file_suratmasuk )
				values ('$tgl_masuk', '$kategori', '$nomor_suratmasuk', '$tgl_surat', '$judul')";
